ALTER TABLE modules
	...
	ADD COLUMN IF NOT EXISTS vocabulary_load integer NOT NULL DEFAULT 0,
	ADD COLUMN IF NOT EXISTS grammar_focus text[] NOT NULL DEFAULT '{}'::text[],
	ADD COLUMN IF NOT EXISTS topic_scope_terms text[] NOT NULL DEFAULT '{}'::text[],
	ADD COLUMN IF NOT EXISTS estimation_duration_minutes integer NOT NULL DEFAULT 0,
	ADD COLUMN IF NOT EXISTS mastery_threshold integer NOT NULL DEFAULT 0;
